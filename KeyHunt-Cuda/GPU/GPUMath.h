...
__device__ __forceinline__ uint64_t Secp256k1ModulusWord(int index)
{
    switch (index)
    {
    case 0:
        return 0xFFFFFFFEFFFFFC2FULL;
    case 1:
    case 2:
    case 3:
...
__device__ __forceinline__ uint64_t Secp256k1ModulusExtendedWord(int index)
{
